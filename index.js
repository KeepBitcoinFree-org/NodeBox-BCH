...
return;
  ...
  if (msglow == 'donate'){
   ...
   socket.emit('update', 'Donate BCH to KeepBitcoinFree.org to support further development:');
   socket.emit('example', 'bitcoincash:qr2fmqy796u2nevuj57vhmcak7vv786zjq389wv7ly');
   return;
  }
